//Yujian Li(yl7kd) middleearth.cpp Section 102 04/26/16
...
/**
 *@brief It initializes a new MiddleEarth object (world)
 *
 *Taking the length, width, number of cities, and a random seed, it shall
 *create a new MiddleEarth object with the given size and number of cities then 
 *randomly takes the name from the string all_city_names as city names.
 *@param xsize the width of the world
 *@param ysize the lenght of the world
...
/**
 *@brief prints the info about the earth
 *
 *As mentioned, it will print the number of cities and the names and 
 *locations inside this MiddleEarth object.
 */
...
/**
 *@brief prints out a table of cities along with its coordianace as locations
 *
 *Using for loops it shall print all the cities in the MiddleEarh object along with
 *their locations
 */
...
/**
 *@brief Computes the distances between two cities
 *
 *Given two strings city1 and city2 as parameters, it will find the distance
 *it takes to reache from one to another.
...
/**
 *@brief It will return vector of strings that list all the cities visited
 *through the trip
 *
 *This method will take a unsigned int as the size of vector and randomly generated
 *cities and push into the vector and return it as the final result
 *@param length an unsigned integer that tells us the how many cities are visited t
 *through the trip
 */
